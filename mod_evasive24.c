...
static int x_forwarded_for_as_client_ip = DEFAULT_X_FORWARDED_FOR_AS_REMOTE_IP;
...
static int access_checker(request_rec *r) 
{
    ...
    if(x_forwarded_for_as_client_ip && (forwarded_for = apr_table_get(r->headers_in, "X-Forwarded-For")) != NULL){
...
static const char*
get_x_forwarded_for_as_client_ip(cmd_parms *cmd, void *dconfig, const char *value){
  long n = strtol(value, NULL, 0);
  if (n>0) {
    x_forwarded_for_as_client_ip = 1;
  } else {
    x_forwarded_for_as_client_ip = 0;
  }
  return NULL; 
}
...
static const command_rec access_cmds[] =
{
  ...
  AP_INIT_TAKE1("DOSXForwardedForAsRemoteIP", get_x_forwarded_for_as_client_ip, NULL, RSRC_CONF,
